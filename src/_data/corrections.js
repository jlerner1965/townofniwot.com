/* Corrections and changes, published with their date and what changed.

   The site promises on several pages that a correction is published with
   the date and a note describing what changed. This is where that promise
   is kept. Newest first. `page` is the URL the entry belongs to; a page
   renders its own entries and Our Story renders them all.

   Add an entry whenever a published fact changes — not for wording or
...
export default [
  ...
  },
  {
    ...
    page: '/events/',
    summary:
      'Hours added to the September 11 Second Friday Art Walk and Osmosis Gallery opening (5 to 9pm) from the organizers’ dated listings; Enchanted Evening moved from “expected” to confirmed for November 27, 2026, 6 to 9pm, from the organizer’s dated listing; the Why Not Niwot? awards night now notes that the Business Association’s calendar gives an earlier start than the organizer’s page; Rock & Rails is credited to the Niwot Cultural Arts Association, which produces it with the Business Association.',
  },
  {
    date: '2026-09-09',
    page: '/civic/incorporation-election/',
  ...
  },
  {
    ...
    page: '/privacy/',
    summary:
      'The opening said nothing beyond two email addresses was collected while later sections described server logs and font requests; it now says what the hosting and font providers process. The statement that nothing is passed to any other organization was reconciled with the naming of Vercel and Resend as processors.',
  },
  {
    date: '2026-09-09',
    page: '/community/',
    summary:
      'Resident resources now link to the county page responsible for each service rather than the county homepage, and a row for the Niwot Sanitation District was added. The Cultural Arts Association, the Historical Society, the Community Association and the county’s Niwot Local Improvement District were added to the organizations list. An unsourced reference to a market run by the Business Association was removed.',
  },
  {
    date: '2026-09-09',
    page: '/eat-shop/',
    summary:
      'John’s Dry Cleaners now links to the company’s locations page after its Niwot address page stopped resolving. Rows that link to the Business Association’s directory rather than to a page of their own are labelled as such.',
  },
];
